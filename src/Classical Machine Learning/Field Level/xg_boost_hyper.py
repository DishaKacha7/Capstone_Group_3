...
joblib.dump(le, './xgb_tuner/label_encoder.joblib')
...
joblib.dump(test_fids, "./xgb_tuner/test_fids.joblib")
...
joblib.dump(imputer, './xgb_tuner/imputer.joblib')
joblib.dump(scaler, './xgb_tuner/scaler.joblib')
...
joblib.dump(study.best_params, './xgb_tuner/best_xgb_params.joblib')
...
joblib.dump(final_model, "./xgb_tuner/final_xgb_model.joblib", compress=3)
