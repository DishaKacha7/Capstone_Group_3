...
OUTPUT_PARQUET = "/home/ubuntu/sai/Capstone_Group_3/src/Data/updated_patch_level_data.parquet"

# Define a chunk size (number of rows per chunk) to reduce memory usage.
CHUNK_SIZE = 100000
    ...
    for idx, patch_row in gdf.iterrows():
        ...
        for r in range(H):
            for c in range(W):
                ...
                # When the chunk size is reached, convert to DataFrame and store.
        ...
        # Optional: Print progress every 100 patches.
